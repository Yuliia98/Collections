...
namespace Task2_Dictionary_
{
    class ActionsWithDictionary
    {
        public static Dictionary<string, int> ReadDictionary()
        {
            ...
            Console.WriteLine("Please enter students and their marks(or enter stop to finish)\n" +
                "Format: Surname:Mark where Surname(one word) and Mark(number from 0 to 5) "); var input = Console.ReadLine();
            while (input != "stop")
            {
                try
                {
                ...
                {
                    Console.WriteLine("Incorrect input - desired format: Surname:Mark(or enter stop to finish) ");
                }
            ...
            do
            {
                ...
                catch
                {
                    Console.WriteLine($"There is no student or mark in this dictionary with {search} parameter.\n" +
                        "Desired format is Surname(one word) or Mark(one number)");
                }
